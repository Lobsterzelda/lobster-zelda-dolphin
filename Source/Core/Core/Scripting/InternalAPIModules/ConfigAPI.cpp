...
static std::array all_config_functions_metadata_list = {
    ...
    FunctionMetadata("getLayerNames_mostGlobalFirst", "1.0", "getLayerNames_mostGlobalFirst()",
                     GetLayerNames_MostGlobalFirst, Scripting::ArgTypeEnum::String, {}),
    FunctionMetadata("doesLayerExist", "1.0", "doesLayerExist(\"Movie\")", DoesLayerExist,
                     Scripting::ArgTypeEnum::Boolean, {Scripting::ArgTypeEnum::String}),
    ...
    FunctionMetadata("getListOfValidValuesForEnumType", "1.0",
                     ...
                     GetListOfValidValuesForEnumType, Scripting::ArgTypeEnum::String,
                     {Scripting::ArgTypeEnum::String}),

    FunctionMetadata("getBooleanConfigSettingForLayer", "1.0",
                     "getBooleanConfigSettingForLayer(\"GlobalGame\", \"Main\", \"Interface\", "
                     "\"debugModeEnabled\")",
                     GetBooleanConfigSettingForLayer, Scripting::ArgTypeEnum::Boolean,
    ...
    FunctionMetadata("setBooleanConfigSettingForLayer", "1.0",
                     ...
                     SetBooleanConfigSettingForLayer, Scripting::ArgTypeEnum::VoidType,
                     {Scripting::ArgTypeEnum::String, Scripting::ArgTypeEnum::String,
                      Scripting::ArgTypeEnum::String, Scripting::ArgTypeEnum::String,
    ...
    FunctionMetadata("setSignedIntConfigSettingForLayer", "1.0",
                     ...
                     "\"TimingVariance\", 30)",
                     SetSignedIntConfigSettingForLayer, Scripting::ArgTypeEnum::VoidType,
                     {Scripting::ArgTypeEnum::String, Scripting::ArgTypeEnum::String,
                      Scripting::ArgTypeEnum::String, Scripting::ArgTypeEnum::String,
                      Scripting::ArgTypeEnum::S32}),
    FunctionMetadata("setUnsignedIntConfigSettingForLayer", "1.0",
                     "setUnsignedIntConfigSettingForLayer(\"GlobalGame\", \"Main\", \"Core\", "
                     "\"MEM1Size\", 500)",
                     SetUnsignedIntConfigSettingForLayer, Scripting::ArgTypeEnum::VoidType,
                     {Scripting::ArgTypeEnum::String, Scripting::ArgTypeEnum::String,
                      Scripting::ArgTypeEnum::String, Scripting::ArgTypeEnum::String,
    ...
    FunctionMetadata("setFloatConfigSettingForLayer", "1.0",
                     ...
                     "\"EmulationSpeed\", 3.4)",
                     SetFloatConfigSettingForLayer, Scripting::ArgTypeEnum::VoidType,
                     {Scripting::ArgTypeEnum::String, Scripting::ArgTypeEnum::String,
                      Scripting::ArgTypeEnum::String, Scripting::ArgTypeEnum::String,
    ...
    FunctionMetadata("setStringConfigSettingForLayer", "1.0",
                     ...
                     SetStringConfigSettingForLayer, Scripting::ArgTypeEnum::VoidType,
                     {Scripting::ArgTypeEnum::String, Scripting::ArgTypeEnum::String,
                      Scripting::ArgTypeEnum::String, Scripting::ArgTypeEnum::String,
                      Scripting::ArgTypeEnum::String}),
    FunctionMetadata("setEnumConfigSettingForLayer", "1.0",
                     ...
                     SetEnumConfigSettingForLayer, Scripting::ArgTypeEnum::VoidType,
                     {Scripting::ArgTypeEnum::String, Scripting::ArgTypeEnum::String,
                      Scripting::ArgTypeEnum::String, Scripting::ArgTypeEnum::String,
                      Scripting::ArgTypeEnum::String, Scripting::ArgTypeEnum::String}),
    ...
    FunctionMetadata(
        ...
        "\"EXIDeviceType\")",
        DeleteEnumConfigSettingFromLayer, Scripting::ArgTypeEnum::Boolean,
        {Scripting::ArgTypeEnum::String, Scripting::ArgTypeEnum::String,
         Scripting::ArgTypeEnum::String, Scripting::ArgTypeEnum::String,
         Scripting::ArgTypeEnum::String}),
